  ...
  return (
    <>
      ...
      <MotionSection className="section">
        <Container className="rounded-[2rem] bg-white p-8 shadow-soft sm:p-10">
          ...
          <p className="lead mt-5">
            ...
            and add-on cleaning, while also making room for specialist hoarders support, home management, and interior decor. Every visit is done with heart, and every
      ...
      <MotionSection className="section bg-cream">
        <Container className="rounded-[2rem] border border-white/70 bg-white p-8 shadow-soft sm:p-10">
          <p className="eyebrow">Founder</p>
          <h2 className="mt-3 font-display text-3xl font-bold leading-tight text-teal-950 sm:text-4xl">Founder-led care, explained separately.</h2>
          <p className="lead mt-5">
            The founder story now has its own page so visitors can understand the support-work experience, communication style, and person-centred values behind the service.
          </p>
          <Link className="btn-primary mt-7" to="/founder">
            Meet the Founder
          </Link>
        </Container>
      </MotionSection>
      ...
      <MotionSection className="section">
        <Container className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-3 font-display text-3xl font-bold leading-tight text-teal-950 sm:text-4xl">Hoarders support needs empathy before action.</h2>
            <p className="lead mt-5">
              Some clients hold on to items because the situation is emotionally difficult, overwhelming, or connected to wider wellbeing needs. In support for hoarders,
              the care is for the person who hoards, not just the cleaning task. The approach is not to rush or shame. It is to communicate, listen, offer choices,
