      ...
      <section className="page-hero">
        <Container className="grid items-center gap-10 lg:grid-cols-[1fr_0.8fr]">
          <div>
            ...
            <h1>Warm, reliable, professional solutions.</h1>
            <p className="lead">Hearty Home Solutions delivers thoughtful support for homes, people, properties, and businesses across Chester and surrounding areas.</p>
          </div>
      ...
      <MotionSection className="section">
        <Container className="rounded-[2rem] bg-white p-8 shadow-soft sm:p-10">
          ...
          <p className="lead mt-5">
            We combine the care of a nurturing touch with the high standards of a modern support service. From everyday needs to sensitive circumstances, we help
            create safer, calmer, more comforting environments where people can breathe, feel settled, and thrive. Every visit is done with heart,
            and every client is treated with respect.
          </p>
        </Container>
      </MotionSection>
      ...
      <MotionSection className="section bg-cream">
        <Container>
          ...
          <p className="lead mt-5 max-w-3xl">
            Our mission is to make every space feel safer, fresher, calmer, and cared for through thoughtful service, attention to detail, and consistent results.
          </p>
        </Container>
      </MotionSection>
